...
class BlankFragment4 : Fragment() {
    ...
    //使用safe args 接收数据
    val args:BlankFragment4Args by navArgs<BlankFragment4Args>()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<TextView>(R.id.textView).text = "myArg=$myArg"
        //通过bundle传递数据
        var string = arguments?.getString("amount")
    }
